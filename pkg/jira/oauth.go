...
func newJIRAHTTPClient(config config.Config) (*http.Client, error) {
...
func oauthConfig(config config.Config) (oauth1.Config, error) {
...
func jiraTokenFromConfig(config config.Config) (*oauth1.Token, bool) {
